...
const TEMPLATE_ECOMMERCE: WorkspaceTemplate = {
  id: "ecommerce",
  name: "E-commerce (CDN + cart API)",
  tagline: "Three-tier retail with separate WAF per tier",
  description:
    "Realistic retail topology: CloudFront fronts static assets, ALB handles the storefront web tier, API Gateway serves the cart/checkout API. Each tier has its own WebACL with tier-appropriate rules — rate limiting tightest on checkout, IP reputation at the edge, CRS on the web tier.",
  icon: "🛒",
  difficulty: "Advanced",
  nodes: [
    { id: "internet", type: "INTERNET", label: "Internet", icon: "🌐", wafAttachable: false, position: { x: 60, y: 280 } },
    { id: "cf", type: "CLOUDFRONT", label: "CloudFront (static)", icon: "☁️", wafAttachable: true, scope: "CLOUDFRONT", position: { x: 260, y: 160 } },
    { id: "waf-cf-node", type: "WAF", label: "Edge WAF", icon: "🛡️", wafAttachable: false, wafId: "waf-cf", position: { x: 260, y: 40 } },
    { id: "s3", type: "S3", label: "S3 assets", icon: "🗄️", wafAttachable: false, position: { x: 500, y: 40 } },
    { id: "alb", type: "ALB", label: "Storefront ALB", icon: "⚖️", wafAttachable: true, scope: "REGIONAL", position: { x: 500, y: 200 } },
    { id: "waf-alb-node", type: "WAF", label: "Web tier WAF", icon: "🛡️", wafAttachable: false, wafId: "waf-alb", position: { x: 500, y: 320 } },
    { id: "ec2", type: "EC2", label: "Web EC2", icon: "🖥️", wafAttachable: false, position: { x: 720, y: 200 } },
    { id: "apigw", type: "API_GATEWAY", label: "Checkout APIGW", icon: "🔌", wafAttachable: true, scope: "REGIONAL", position: { x: 500, y: 480 } },
    { id: "waf-apigw-node", type: "WAF", label: "Checkout WAF", icon: "🛡️", wafAttachable: false, wafId: "waf-apigw", position: { x: 500, y: 600 } },
    { id: "lambda-cart", type: "LAMBDA", label: "Cart Lambda", icon: "⚡", wafAttachable: false, position: { x: 720, y: 440 } },
    { id: "lambda-pay", type: "LAMBDA", label: "Payment Lambda", icon: "⚡", wafAttachable: false, position: { x: 720, y: 520 } },
  ],
  edges: [
    { id: "e1", source: "internet", target: "cf" },
    { id: "e2", source: "cf", target: "s3" },
    { id: "e3", source: "cf", target: "alb" },
    { id: "e4", source: "alb", target: "ec2" },
    { id: "e5", source: "cf", target: "apigw" },
    { id: "e6", source: "apigw", target: "lambda-cart" },
    { id: "e7", source: "apigw", target: "lambda-pay" },
    { id: "p1", source: "waf-cf-node", target: "cf", wafId: "waf-cf" },
    { id: "p2", source: "waf-alb-node", target: "alb", wafId: "waf-alb" },
    { id: "p3", source: "waf-apigw-node", target: "apigw", wafId: "waf-apigw" },
  ],
  wafs: [
    ...
    },
    {
      ...
      defaultAction: "ALLOW",
      capacity: 1500,
      visibilityConfig: viz("WebTierWAF"),
      rules: [
        {
          name: "CommonRuleSet",
          priority: 10,
    ...
    },
    {
      ...
      defaultAction: "ALLOW",
      capacity: 1500,
      visibilityConfig: viz("CheckoutWAF"),
      rules: [
        {
          ...
          visibilityConfig: viz("CheckoutRate"),
        },
        {
          name: "SQLiRuleSet",
          priority: 10,
...
const TEMPLATE_MICROSERVICES: WorkspaceTemplate = {
  id: "microservices",
  name: "Microservices API mesh",
  tagline: "Shared API Gateway, per-service Lambda, fine-grained rate limits",
  description:
    "Common SaaS pattern: one API Gateway front door, four Lambda-backed services (auth, users, billing, search). Single WebACL on the gateway with a tight global rate limit plus a stricter one scoped to /login, IP reputation, CRS, SQLi rule set. Demonstrates scope-down statements on rate-based rules.",
  icon: "🕸️",
  difficulty: "Advanced",
  nodes: [
    { id: "internet", type: "INTERNET", label: "Internet", icon: "🌐", wafAttachable: false, position: { x: 60, y: 300 } },
    { id: "apigw", type: "API_GATEWAY", label: "API Gateway", icon: "🔌", wafAttachable: true, scope: "REGIONAL", position: { x: 280, y: 300 } },
    { id: "waf-apigw-node", type: "WAF", label: "API WAF", icon: "🛡️", wafAttachable: false, wafId: "waf-apigw", position: { x: 280, y: 160 } },
    { id: "lambda-auth", type: "LAMBDA", label: "Auth /login", icon: "⚡", wafAttachable: false, position: { x: 560, y: 120 } },
    { id: "lambda-users", type: "LAMBDA", label: "Users /me", icon: "⚡", wafAttachable: false, position: { x: 560, y: 240 } },
    { id: "lambda-billing", type: "LAMBDA", label: "Billing /invoice", icon: "⚡", wafAttachable: false, position: { x: 560, y: 360 } },
    { id: "lambda-search", type: "LAMBDA", label: "Search /q", icon: "⚡", wafAttachable: false, position: { x: 560, y: 480 } },
  ],
  edges: [
    { id: "e1", source: "internet", target: "apigw" },
    { id: "e2", source: "apigw", target: "lambda-auth" },
    { id: "e3", source: "apigw", target: "lambda-users" },
    { id: "e4", source: "apigw", target: "lambda-billing" },
    { id: "e5", source: "apigw", target: "lambda-search" },
    { id: "p1", source: "waf-apigw-node", target: "apigw", wafId: "waf-apigw" },
  ],
  wafs: [
    {
      ...
      defaultAction: "ALLOW",
      capacity: 1500,
      visibilityConfig: viz("APIMeshWAF"),
      rules: [
        {
          name: "RateLimitGlobal",
          priority: 5,
        ...
        },
        {
          ...
          visibilityConfig: viz("RateLimitAuth"),
        },
        {
          name: "IPReputation",
          priority: 20,
